...
def main(args):
    ...
    for year in range(2013, 2015):
        ...
        for midx, m in enumerate(month_list):
            ...
            samples = FileListClassificationSamples(None, TrainMalSamples, TrainGoodSamples, TestMalSamples, TestGoodSamples, FeatureOption, SaveModelName, 30)
            for item in samples:
                print(item)
